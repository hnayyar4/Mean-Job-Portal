...
export function Home(){
  ...
  const [myImgData , setMyImgdata] = useState([]);
    useEffect(()=>{
  ...
  <div className="slider-area ">
    ...
    <div className="slider-active">
      <div
        className="single-slider slider-height d-flex align-items-center background1"
        ...
        {myData.map((el, index)=>(
          ...
          <div className="single-services text-center mb-30" style={{height:300}}>
            ...
            <div className="services-cap">
              <h5>
                <a href="job_listing.html">{el.categoryDescription}</a>
              </h5>
      ...
      <div className="row">
        <div className="col-lg-12">
          <div className="browse-btn2 text-center mt-50">
            <Link to={"/categories"} className="border-btn2">
              Browse All Sectors
            </Link>
          </div>
        </div>
  ...
  <div
    ...
    data-background="assets/img/gallery/cv_bg.jpg" style={{backgroundImage:"url('/assets/img/gallery/cv_bg.jpg')"}}
  >
    <div className="container">
        ...
        <div className="col-xl-10">
          <div className="cv-caption text-center">
            ...
            <Link to={"#"} className="border-btn2 border-btn4">
              Upload your cv <input type="file" name="" id=""/>
            </Link>
          </div>
        </div>
      </div>
    ...
    <div className="container">
      ...
      <div className="single-job-items mb-30">
                ...
                <Link to={"/applyjobs/"+ el._id}>Apply Now!</Link>
                  ...
                  <span>Start Date: {el.startDate}</span>
                  <span>Posted At: {el.createdAt}</span>
